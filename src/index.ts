...
function logValidation(name: string, isValid: boolean, value: any): void {
...
function validateAndLog(name: string, validator: (value: any) => boolean, value: any): boolean {
    try {
...
export function isPassword(value: any, minLength: number = 8): boolean {
...
export function isLocation(value: any, maxLength: number = 50): boolean {
...
export function isPostalCode(value: any, country: string = 'US'): boolean {
    let pattern;
...
export function isDate(value: any, format: string = 'YYYY-MM-DD'): boolean {
    let pattern;
    switch (format) {
        case 'YYYY-MM-DD':
            pattern = /^\d{4}-\d{2}-\d{2}$/;
